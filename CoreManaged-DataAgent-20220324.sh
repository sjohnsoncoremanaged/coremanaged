...
if [ -z "https://itindianapolis.services-us3.cloudradial.com" ]; then
    echo "Please enter a valid service endpoint URL."
    exit 1
fi
if [ -z "https://itindianapolis.us.cloudradial.com" ]; then
...
echo ""
echo "Service Endpoint: https://itindianapolis.services-us3.cloudradial.com"
echo "Partner Url:      https://itindianapolis.us.cloudradial.com"
echo "Company Id:       1"
echo "Security Key:     "
echo ""
...
plutil -insert ProgramArguments -xml "<array><string>/Library/LaunchDaemons/CloudRadial.Mac.Agent/CloudRadial.Mac.Agent</string><string>https://itindianapolis.services-us3.cloudradial.com</string><string>https://itindianapolis.us.cloudradial.com</string><string>1</string><string></string></array>" /Library/LaunchDaemons/com.cloudradial.mac.agent.plist
